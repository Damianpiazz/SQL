...
/*Registrar la devolucion de un producto, incrementar el stock del articulo, 
y dejar registro en la tabla de movimientos de stock. Si falla alguna operacion, se revierte todo.*/
